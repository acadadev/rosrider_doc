...
<div class="highlight notranslate position-relative overflow-auto">
  ...
  <clipboard-copy class="ClipboardButton btn js-clipboard-copy" for="blob-path2">Copy</clipboard-copy>
</div>


<div class="highlight highlight-source-js notranslate position-relative overflow-auto" dir="auto"><pre><span class="pl-k">import</span> <span class="pl-s">'@github/clipboard-copy-element'</span></pre>

  <div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="import '@github/clipboard-copy-element'" tabindex="0" role="button">
