...
<div style="display: flex; justify-content: space-around; margin: 25px 0;">
  <img src="/images/sorcerer_rosrider_intro.jpg" alt="Sorcerer application project" style="width: 30%; border: 1px solid #ccc; border-radius: 5px; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">
